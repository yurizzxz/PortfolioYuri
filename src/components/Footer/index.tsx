      ...
      <div className="max-w-6xl  mx-auto flex flex-col md:flex-row justify-between gap-16">
        <div className="flex-1">
          ...
          <p className="text-sm text-zinc-300">
            Desenvolvendo soluções com foco em experiência e
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-4 text-zinc-300">
            <Link href="https://github.com/yurizzxz" target="_blank" rel="noopener noreferrer">
              <Github />
            </Link>
            <Link href="https://linkedin.com/in/yurizzxz" target="_blank" rel="noopener noreferrer">
              <Linkedin />
            </Link>
            <Link href="https://instagram.com/yurinsights" target="_blank" rel="noopener noreferrer">
              <Instagram />
            </Link>
          </div>
        </div>
